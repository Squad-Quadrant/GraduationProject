...
{
	public class TargetInfoPanel : UIPanel, IInitializable<Systems.Unit.Unit>
	{
		...
		[SerializeField, Required, ChildGameObjectsOnly] private Image weaponBackground;
		[SerializeField, Required, AssetsOnly] private Sprite playerBackground;
		[SerializeField, Required, AssetsOnly] private Sprite playerWeaponBackground;
		[SerializeField, Required, AssetsOnly] private Sprite enemyBackground;
		[SerializeField, Required, AssetsOnly] private Sprite enemyWeaponBackground;
        ...
        {
            if (e.Unit != _unit) return;
            Refresh(e.Unit);
        }

        public void Refresh(Systems.Unit.Unit unit)
        {
	        background.sprite = unit.faction == EUnitFaction.Player ? playerBackground : enemyBackground;
	        weaponBackground.sprite = unit.faction == EUnitFaction.Player ? playerWeaponBackground : enemyWeaponBackground;
