...
namespace Systems.Vision
{
    public interface IVisionService
    {
        ...
        // Vision blockers
        IReadOnlyCollection<Vector2Int> VisionBlockingCells { get; }
        VisionBlockerToken AddVisionBlocker(IReadOnlyList<Vector2Int> cells);
        void RemoveVisionBlocker(VisionBlockerToken token);
