...
namespace HighlightPlus2D {
    ...
    public class HighlightEffectEditor : Editor {
        ...
        SerializedProperty shadowIntensity, shadowColor, shadowOffset, shadow3D, shadowDithering;
        ...
        void OnEnable() {
            ...
            shadowDithering = serializedObject.FindProperty("shadowDithering");
        }
        ...
        public override void OnInspectorGUI() {
            ...
            if (!occluder.boolValue) {
                ...
                if (shadow3D.boolValue) {
                    EditorGUILayout.PropertyField(shadowDithering, new GUIContent("Dithering"));
                } else {
